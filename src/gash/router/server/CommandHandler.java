...
public class CommandHandler extends SimpleChannelInboundHandler<CommandMessage> {
	...
	public void handleMessage(CommandMessage msg, Channel channel) {
		...
		try {
			...
			if (msg.hasPing()) {
				//write the code for passing the message to the intended 
				
				//if(conf.getNodeId()==msg.getHeader().getNodeId()){
				//System.out.println("I got my ping");
				logger.info("ping from " + msg.getHeader().getNodeId()+" to "+msg.getHeader().getDestination());
				PrintUtil.printCommand(msg);
				//}
				/*else{
					System.out.println("Its not mine im forwarding");
